...
- 词义列表 (meanings，包含WordMeaning值对象)
...
#### 单词词义 (WordMeaning)
- ID (标识符)
- 词性ID (partOfSpeechId，引用词性实体)
- 中文意思 (chineseMeaning)
- 例句列表 (exampleSentenceIds，引用句子实体)
- 同义词列表 (synonymWordMeaningIds，引用其他WordMeaning)
- 反义词列表 (antonymWordMeaningIds，引用其他WordMeaning)
...
- 根实体: 单词 (Word)
- 包含: 发音、WordMeaning值对象
- 关系: WordMeaning通过exampleSentenceIds引用句子实体
...
- 单词已创建 (WordCreated)
- 单词已更新 (WordUpdated)
- 单词词义已添加 (WordMeaningAdded)
- 例句已添加到词义 (ExampleSentenceAddedToWordMeaning)
- 例句已从词义移除 (ExampleSentenceRemovedFromWordMeaning)
