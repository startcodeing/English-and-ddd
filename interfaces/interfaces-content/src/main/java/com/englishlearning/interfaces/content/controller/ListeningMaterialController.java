...
public class ListeningMaterialController {
    ...
    public Object createListeningMaterial(
        ...
        try {
            ...
            ListeningMaterialDTO result = listeningMaterialApplicationService.create(dto, audioFile);
    ...
    public Object updateListeningMaterial(
        ...
        try {
            ...
            ListeningMaterialDTO result = listeningMaterialApplicationService.update(dto, audioFile);
            return ResultUtils.success(result);
        } catch (Exception e) {
            return ResultUtils.error(e.getMessage());
        }
    ...
    public Object deleteListeningMaterial(@PathVariable("id") Long id) {
        try {
            listeningMaterialApplicationService.deleteById(id);
