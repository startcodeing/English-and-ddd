...
public class ArticleController {
     ...
     * 为文章添加句子
     */
    @PostMapping("/{id}/sentences/{sentenceId}")
    public Result<ArticleDTO> addSentence(@PathVariable String id, @PathVariable String sentenceId) {
        return Result.success(articleService.addSentence(id, sentenceId));
    }
    ...
    public Result<ArticleDTO> addUnfamiliarWord(@PathVariable String id,@PathVariable String wordId) {
        return Result.success(articleService.addUnfamiliarWord(id, wordId));
    }
    ...
    public Result<ArticleDTO> extractSentences(@PathVariable String id) {
    ...
    public Result<ArticleDTO> identifyUnfamiliarWords(
